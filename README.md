...
4. Using the frequencies as weights, `process.py` generates 1000 rows of 6-number sequences without replacement (lottery trials).
...
## Why that many scripts?
For me, this is a best practice. I create this project in 10 hours so don't be so hard! 😬
